...
gsl_vector *LinearRegression_Fitting(gsl_matrix *X, gsl_vector *Y, mac_prtFun Function, int FUNCTION_ID, ...); /* It fits a linear regression model using the Minimum Square Error as the error function */
