...
double MyBernoulliRBMTrainingbyPersistentContrastiveDivergence(Dataset *D, RBM *m, int n_epochs, int n_PCD_iterations, int batch_size); // It trains a Bernoulli RBM by Persistent Constrative Divergence
double BernoulliRBMTrainingbyFastPersistentContrastiveDivergence(Dataset *D, RBM *m, int n_epochs, int batch_size); // It trains a Bernoulli RBM by Fast Persistent Constrative Divergence
...
gsl_vector *getProbabilityTurningOnHiddenUnit4FPCD(RBM *m, gsl_vector *v, gsl_matrix *fast_W, gsl_vector *fast_b); // It computes the probability of turning on a hidden unit j for FPCD
...
gsl_vector *getProbabilityTurningOnVisibleUnit4FPCD(RBM *m, gsl_vector *h, gsl_matrix *fast_W, gsl_vector *fast_a); // It computes the probability of turning on a visible unit j for FPCD
