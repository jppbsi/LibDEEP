...
int main(int argc, char **argv)
{
    ...
    if (argc != 12)
    {
        fprintf(stderr, "\nusage DropoutDBM <training set> <test set> <output results file name> <cross-validation iteration number> \
    ...
    fprintf(stderr, "\nCreating and initializing Dropout DBM ... ");
