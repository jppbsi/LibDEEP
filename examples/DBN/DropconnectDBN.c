...
int main(int argc, char **argv){
    ...
    if(argc != 11){
        fprintf(stderr,"\nusage DropconnectDBN <training set> <test set> <output results file name> <cross-validation iteration number> \
    ...
    fprintf(stderr,"\nCreating and initializing Dropconnect DBN ... ");
    ...
    fprintf(stderr,"\nRunning Dropconnect DBN for reconstruction ... ");
