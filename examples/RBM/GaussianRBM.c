...
int main(int argc, char **argv)
{
    ...
    if (argc != 10)
    {
        fprintf(stderr, "\nusage GaussianRBM <training set> <test set> <output results file name> <cross-validation iteration number> \
    ...
    fprintf(stderr, "\nCreating and initializing Gaussian RBM ... ");
