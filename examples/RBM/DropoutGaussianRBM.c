...
int main(int argc, char **argv){
    ...
    if(argc != 10){
        fprintf(stderr,"\nusage DropoutGaussianRBM <training set> <test set> <output results file name> <cross-validation iteration number> \
    ...
    fprintf(stderr,"\nCreating and initializing Dropout Gaussian RBM ... ");
    ...
    fprintf(stderr,"\nRunning Dropout Gaussian RBM for classification ... ");
