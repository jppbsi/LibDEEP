...
int main(int argc, char **argv){
    ...
    if(argc != 9){
        fprintf(stderr,"\nusage DRBM <training set> <test set> <output results file name> <cross-validation iteration number> \
    ...
    fprintf(stderr,"\nRunning Gaussian DRBM for classification ... ");
